...
namespace Program1
{
    ...
    public class Order
    {
        public OrderDetails goodsADetails = new OrderDetails("goodsA", 1000);
        public OrderDetails goodsBDetails = new OrderDetails("goodsB", 1500);
        public OrderDetails goodsCDetails = new OrderDetails("goodsC", 1800);
    ...
    public class OrderService
    {
        ...
        //通过订单金额
        public void FindOrderByTotalPrice()
        {
            foreach (Order order in orders)
            {
                if (order.TotalPrice() > 10000)
                    Console.WriteLine("通过订单金额找到订单,订单金额为" + order.TotalPrice() + "，大于10000");
            }
        }
    }
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            orderService.FindOrderByTotalPrice();
